...
namespace HotelCheckIn_PlatformSystem
{
            ...
            for (int i = 0; i < count; i++)
            {
                if (i == 0 && count > 1) //第一个菜单项
                {
                    if (dt.Rows[i]["level_id"].ToString() == "1") //二级菜单
                    {
                        ...
                        {
                            menuStr += "<li class='dropdown-menu'><a class='dropdown-toggle' href=\"javascript:void(0)\" onclick=\"sf('" +
                                       dt.Rows[i]["href"] + "',null)\">" + dt.Rows[i]["caption"] + "</a></li>";
                        }
                        else
                        {
                            menuStr += "<li class='dropdown-menu'><a href=\"javascript:void(0)\" >" + dt.Rows[i]["parentname"].ToString()
                                       + "</a><ul class='dropdown-menu'><li><a href=\"javascript:void(0)\" onclick=\"sf('" +
                    ...
                    else //三级菜单
                    {
                        ...
                        {
                            menuStr += "<li class='dropdown-menu'><a href=\"javascript:void(0)\" >" + dt.Rows[i]["ppname"]
                                       + "</a><ul class='dropdown-menu'><li><a href=\"javascript:void(0)\">" + dt.Rows[i]["parentname"]
                                       + "</a><ul class='dropdown-menu'><li><a href=\"javascript:void(0)\" onclick=\"sf('" +
                    ...
                    if (dt.Rows[i]["level_id"].ToString() == "1") //二级菜单
                    {
                            ...
                            dt.Rows[i]["parentname"].ToString() != dt.Rows[i + 1]["parentname"].ToString())
                        {
                            menuStr += "<li><a href=\"javascript:void(0)\" onclick=\"sf('" +
                                       ...
                                       "',null)\">" + dt.Rows[i]["parentname"].ToString() + "</a><ul class='dropdown-menu'>";
                        }
                        else if (dt.Rows[i]["parentname"].ToString() != dt.Rows[i - 1]["parentname"].ToString() &&
                                 dt.Rows[i]["parentname"].ToString() == dt.Rows[i + 1]["parentname"].ToString())
                        {
                    ...
                    else //三级菜单
                    {
                                 ...
                                 dt.Rows[i]["ppname"].ToString() == dt.Rows[i + 1]["ppname"].ToString())
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    menuStr += "<li class='dropdown-menu'><a href=\"javascript:void(0)\" >" + dt.Rows[i]["ppname"]
                                               + "</a><ul class='dropdown-menu'><li><a href=\"javascript:void(0)\">" +
                                 ...
                                 dt.Rows[i]["ppname"].ToString() != dt.Rows[i + 1]["ppname"].ToString())
                        {
                            ...
                            else
                            {
                                if (dt.Rows[i]["parentname"].ToString() != dt.Rows[i - 1]["parentname"].ToString())
                                {
                                    menuStr += "<li class='dropdown-menu'><a href=\"javascript:void(0)\">" +
                                               dt.Rows[i]["parentname"] +
                                               "</a><ul class='dropdown-menu'><li><a href=\"javascript:void(0)\" onclick=\"sf('" +
                                               dt.Rows[i]["href"] + "',this)\">" + dt.Rows[i]["caption"] +
                                               "</a></li></ul></li></ul></li>";
                ...
                else if (i == count - 1 && count > 1) //最后一个菜单项
                {
                    if (dt.Rows[i]["level_id"].ToString() == "1") //二级菜单
                    {
                        if (dt.Rows[i]["parentname"].ToString() != dt.Rows[i - 1]["parentname"].ToString())
                        {
                            menuStr += "<li class='dropdown-menu'><a href=\"javascript:void(0)\" onclick=\"sf('" +
                                       dt.Rows[i]["href"].ToString() +
                ...
                {
                    menuStr += "<li class='dropdown-menu'><a href=\"javascript:void(0)\" onclick=\"sf('" + dt.Rows[i]["href"].ToString() +
