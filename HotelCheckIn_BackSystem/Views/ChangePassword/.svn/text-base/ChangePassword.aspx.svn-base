<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="HotelCheckIn_BackSystem.Views.ChangePassword.ChangePassword1" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../../Scripts/jquery-easyui-1.3.1/easyui-lang-zh_CN.js" type="text/javascript"></script>
    ...
    <style type="text/css">
        ...
        #txtPass,#txtNewPass,#txtNewPass2 {
            width: 150px;
        }
    </style>
</head>
